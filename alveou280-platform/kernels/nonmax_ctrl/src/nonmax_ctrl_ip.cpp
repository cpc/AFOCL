...
#pragma HLS pipeline II=1 style=flp
            t_Vec_o output_data;
            t_Vec_o phase_data = in1.read().data;
            ...
            packet_o packet_out;
            packet_out.dest = tdest;
            packet_out.data = output_data;
            out0.write(packet_out);
        }
    }
}
